      ...
      if (!params.identifier) {
        return ctx.badRequest(
          ...
          formatError({
            ...
            message: "Please provide your phone or your e-mail.",
          })
        );
      }
  ...
  async register(ctx) {
    ...
    if (user && user.provider !== params.provider && settings.unique_email) {
      return ctx.badRequest(
        ...
        formatError({
          ...
          message: "Email is already taken2",
        })
      );
    }
    ...
    try {
      ...
      params.friends = [
        ...
        "613a5380660bf9615c85362f",
        "613a5472660bf9615c853632",
        "613a5565660bf9615c853635",
        "612a750c9c011118947744f9",
      ];
